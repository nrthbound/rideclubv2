    ...
    <div class="template-container">
        ...
        <div class="columns">
            <div class="column is-half is-offset-one-quarter">
                <ul>
                    <li class="error" v-for="error in errors" v-text="error"></li>
                </ul>
            </div>
        </div>
        ...
        <div class="columns">
            <div class="column is-half is-offset-one-quarter">
                <div class="form-row">
                    <div class="form-box">
                        <div class="box-title has-icon no-title">
                            <div class="form-icon has-shadow"  v-bind:class="{ 'is-validated' : buildName.length >= 6, 'is-danger' : errors.buildName && buildName.length < 6 }">
                                <i class="material-icons">done</i>
                            </div>
                        </div>
                        <label for="build-name" class="is-sr">Build Name</label>
                        <input type="text" name="build-name" v-model="buildName" id="build-name" class="descriptor has-shadow buildName" placeholder="Build Name" value="">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-box has-shadow">
                        <div class="box-title has-icon">
                            <div class="form-icon has-shadow" v-bind:class="{ 'is-validated': buildType, 'is-danger' : errors.buildType && buildType.length <= 0  }">
                                <i class="material-icons">done</i>
                            </div>
                ...
                <div class="form-row" v-show="buildType == 'skateboard'">
                    <div class="form-box has-shadow">
                        <div class="box-body">
                            <div class="columns">
                                <div class="column">
                ...
                <div class="form-row" v-show="buildType == 'bike'">
                    <div class="form-box has-shadow">
                        <div class="box-body">
                            <div class="columns">
                                <div class="column">
